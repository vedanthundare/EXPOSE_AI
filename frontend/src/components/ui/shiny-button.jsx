...
export function ShinyButton({ children, onClick, disabled = false, className = "" }) {
  return (
    <>
      <style>{`
        ...
        .shiny-cta {
          ...
          --shiny-cta-fg: #ffffff;
          --shiny-cta-highlight: #00F0FF;
          --shiny-cta-highlight-subtle: #A0F8FF;
        ...
        .shiny-cta:disabled::after, .shiny-cta:disabled::before {
          display: none;
        }
